...
import { ArrowRight, Star, Phone, Mail, MapPin, Facebook, Instagram, Twitter, Menu, X, Eye, Heart, ShoppingCart, Award, Truck, Shield, Clock, Play, ChevronLeft, ChevronRight } from 'lucide-react';
import AOS from 'aos';
...
function App() {
  ...
  const heroSlides = [
    {
      ...
      description: 'Khám phá bộ sưu tập nội thất cao cấp với thiết kế độc đáo và chất lượng vượt trội'
    },
    {
      ...
      description: 'Mang đến không gian sống hoàn hảo với những sản phẩm được tuyển chọn kỹ lưỡng'
    },
    {
      ...
      description: 'Cam kết mang đến trải nghiệm mua sắm tuyệt vời với dịch vụ chăm sóc khách hàng 5 sao'
    }
  ];
  ...
  const products = [
    ...
    },
    {
      ...
      image: 'https://images.pexels.com/photos/586744/pexels-photo-586744.jpeg?auto=compress&cs=tinysrgb&w=600',
      category: 'Ghế',
      badge: 'Premium',
      rating: 5.0
    }
  ...
  const testimonials = [
    {
      ...
      content: 'Chất lượng sản phẩm tuyệt vời, thiết kế sang trọng và dịch vụ chăm sóc khách hàng rất chu đáo. Tôi đã mua toàn bộ nội thất cho văn phòng mới và rất hài lòng.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'Đã hợp tác trong nhiều dự án lớn. Sản phẩm luôn đảm bảo chất lượng cao cấp và giao hàng đúng thời hạn cam kết. Đội ngũ tư vấn rất chuyên nghiệp.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'Là đối tác tin cậy trong các dự án thiết kế nội thất cao cấp. Sản phẩm đa dạng, chất lượng ổn định và luôn theo kịp xu hướng thiết kế mới nhất.',
      rating: 5,
  ...
  return (
    <div className="bg-white min-h-screen overflow-x-hidden">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:block" data-aos="fade-down" data-aos-delay="200">
              <div className="flex items-baseline space-x-8 ml-10">
                <a href="#home" className="group relative font-medium text-gray-700 hover:text-amber-600 transition-all duration-300">
                  Trang Chủ
                  <span className="-bottom-1 left-0 absolute bg-amber-600 w-0 group-hover:w-full h-0.5 transition-all duration-300"></span>
                </a>
                <a href="#products" className="group relative font-medium text-gray-700 hover:text-amber-600 transition-all duration-300">
                  Sản Phẩm
                  <span className="-bottom-1 left-0 absolute bg-amber-600 w-0 group-hover:w-full h-0.5 transition-all duration-300"></span>
                </a>
                <a href="#about" className="group relative font-medium text-gray-700 hover:text-amber-600 transition-all duration-300">
                  Giới Thiệu
                  <span className="-bottom-1 left-0 absolute bg-amber-600 w-0 group-hover:w-full h-0.5 transition-all duration-300"></span>
                </a>
                <a href="#testimonials" className="group relative font-medium text-gray-700 hover:text-amber-600 transition-all duration-300">
                  Đánh Giá
                  <span className="-bottom-1 left-0 absolute bg-amber-600 w-0 group-hover:w-full h-0.5 transition-all duration-300"></span>
                </a>
                <a href="#contact" className="group relative font-medium text-gray-700 hover:text-amber-600 transition-all duration-300">
                  Liên Hệ
                  <span className="-bottom-1 left-0 absolute bg-amber-600 w-0 group-hover:w-full h-0.5 transition-all duration-300"></span>
                </a>
              </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white/95 shadow-xl backdrop-blur-lg border-t">
            <div className="space-y-1 px-2 pt-2 pb-3">
              <a href="#home" className="block hover:bg-amber-50 px-4 py-3 rounded-lg text-gray-700 hover:text-amber-600 transition-all duration-300">Trang Chủ</a>
              <a href="#products" className="block hover:bg-amber-50 px-4 py-3 rounded-lg text-gray-700 hover:text-amber-600 transition-all duration-300">Sản Phẩm</a>
              <a href="#about" className="block hover:bg-amber-50 px-4 py-3 rounded-lg text-gray-700 hover:text-amber-600 transition-all duration-300">Giới Thiệu</a>
              <a href="#testimonials" className="block hover:bg-amber-50 px-4 py-3 rounded-lg text-gray-700 hover:text-amber-600 transition-all duration-300">Đánh Giá</a>
              <a href="#contact" className="block hover:bg-amber-50 px-4 py-3 rounded-lg text-gray-700 hover:text-amber-600 transition-all duration-300">Liên Hệ</a>
      ...
      <section id="home" className="relative flex justify-center items-center h-screen overflow-hidden">
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="flex justify-center items-center bg-gradient-to-br from-amber-100 to-amber-50 group-hover:shadow-xl mx-auto mb-4 p-6 rounded-2xl w-20 h-20 transition-all duration-500">
                  <feature.icon className="text-amber-600 group-hover:scale-110 transition-transform duration-300" size={32} />
                </div>
                <h3 className="mb-2 font-bold text-gray-900 text-xl">{feature.title}</h3>
        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="mb-20 text-center" data-aos="fade-up">
            <h2 className="mb-6 font-bold text-gray-900 text-5xl md:text-6xl">
              Bộ Sưu Tập <span className="bg-clip-text bg-gradient-to-r from-amber-600 to-amber-500 text-transparent">Đặc Biệt</span>
            </h2>
            <p className="mx-auto max-w-3xl text-gray-600 text-xl leading-relaxed">
              Khám phá những sản phẩm nội thất cao cấp được thiết kế đặc biệt với chất lượng vượt trội và phong cách hiện đại
            </p>
          </div>
                ...
                <div className="relative overflow-hidden">
                  ...
                  <div className="top-4 left-4 absolute">
                    <span className={`px-4 py-2 rounded-full text-sm font-bold text-white shadow-lg ${
                      product.badge === 'Bán Chạy' ? 'bg-gradient-to-r from-red-500 to-red-600' :
                      product.badge === 'Mới' ? 'bg-gradient-to-r from-green-500 to-green-600' :
                      product.badge === 'Hot' ? 'bg-gradient-to-r from-orange-500 to-orange-600' :
                ...
                <div className="p-8">
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="font-semibold text-gray-700 text-sm">{product.rating}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    <span className="font-bold text-amber-600 text-2xl">{product.price}</span>
      ...
      {/* About Section */}
      <section id="about" className="bg-gradient-to-br from-gray-50 via-white to-gray-50 py-24">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="items-center gap-16 grid grid-cols-1 lg:grid-cols-2">
            <div data-aos="fade-right" data-aos-duration="1000">
              <h2 className="mb-8 font-bold text-gray-900 text-5xl md:text-6xl">
                Tại Sao Chọn <span className="bg-clip-text bg-gradient-to-r from-amber-600 to-amber-500 text-transparent">LuxuryHome?</span>
              </h2>
              <p className="mb-10 text-gray-600 text-xl leading-relaxed">
                Với hơn 15 năm kinh nghiệm trong ngành nội thất, chúng tôi cam kết mang đến những sản phẩm chất lượng cao nhất và dịch vụ tận tâm nhất cho khách hàng.
              </p>
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-6" data-aos="fade-up" data-aos-delay="100">
                  ...
                  <div>
                    <h3 className="mb-3 font-bold text-gray-900 text-2xl">Chất Lượng Cao Cấp</h3>
                    <p className="text-gray-600 leading-relaxed">Sản phẩm được chọn lọc kỹ càng từ các nhà sản xuất uy tín trên thế giới với tiêu chuẩn chất lượng khắt khe</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-6" data-aos="fade-up" data-aos-delay="200">
                  ...
                  <div>
                    <h3 className="mb-3 font-bold text-gray-900 text-2xl">Thiết Kế Độc Đáo</h3>
                    <p className="text-gray-600 leading-relaxed">Mỗi sản phẩm đều mang đậm dấu ấn riêng biệt và phong cách hiện đại, phù hợp với xu hướng thiết kế mới nhất</p>
                  </div>
                </div>
                
                <div className="flex items-start gap-6" data-aos="fade-up" data-aos-delay="300">
                  <div className="bg-gradient-to-br from-amber-100 to-amber-50 shadow-lg p-4 rounded-2xl">
                    <Heart className="text-amber-600" size={28} />
                  </div>
                  <div>
                    <h3 className="mb-3 font-bold text-gray-900 text-2xl">Dịch Vụ Tận Tâm</h3>
                    <p className="text-gray-600 leading-relaxed">Đội ngũ tư vấn chuyên nghiệp, hỗ trợ 24/7 và chế độ bảo hành uy tín lên đến 5 năm</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative" data-aos="fade-left" data-aos-duration="1000">
              ...
              <div className="-bottom-8 -left-8 absolute bg-gradient-to-r from-amber-600 to-amber-500 shadow-2xl p-8 rounded-2xl text-white hover:scale-105 transition-transform duration-300 transform" data-aos="zoom-in" data-aos-delay="400">
                <div className="mb-2 font-bold text-4xl">15+</div>
                <div className="opacity-90 text-sm">Năm Kinh Nghiệm</div>
              </div>
              
              <div className="-top-8 -right-8 absolute bg-white shadow-2xl p-8 rounded-2xl hover:scale-105 transition-transform duration-300 transform" data-aos="zoom-in" data-aos-delay="600">
                <div className="mb-2 font-bold text-amber-600 text-4xl">10K+</div>
      ...
      <section id="testimonials" className="bg-gradient-to-b from-gray-900 to-gray-800 py-24 text-white">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="mb-20 text-center" data-aos="fade-up">
            <h2 className="mb-6 font-bold text-5xl md:text-6xl">
              Khách Hàng <span className="bg-clip-text bg-gradient-to-r from-amber-400 to-amber-300 text-transparent">Nói Gì</span>
            </h2>
            <p className="mx-auto max-w-3xl text-gray-300 text-xl">
              Hơn 10,000 khách hàng đã tin tưởng và hài lòng với sản phẩm cũng như dịch vụ của chúng tôi
            </p>
          </div>
              ...
              >
                <div className="flex items-center gap-2 mb-6">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star key={i} className="fill-current text-amber-400" size={20} />
                  ))}
                </div>
                
                <p className="mb-8 text-gray-300 text-lg italic leading-relaxed">"{testimonial.content}"</p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="font-medium text-amber-400 text-sm">{testimonial.role}</div>
                    <div className="text-gray-400 text-xs">{testimonial.project}</div>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="z-10 relative mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl text-center">
          <div data-aos="zoom-in" data-aos-duration="1000">
            ...
            <p className="mx-auto mb-12 max-w-4xl text-amber-100 text-xl leading-relaxed">
              Liên hệ ngay với chúng tôi để được tư vấn miễn phí và nhận ưu đãi đặc biệt lên đến 30% cho đơn hàng đầu tiên
            </p>
          </div>
      ...
      <section id="contact" className="bg-white py-24">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="mb-20 text-center" data-aos="fade-up">
            <h2 className="mb-6 font-bold text-gray-900 text-5xl md:text-6xl">
              Liên Hệ <span className="bg-clip-text bg-gradient-to-r from-amber-600 to-amber-500 text-transparent">Với Chúng Tôi</span>
            </h2>
            <p className="mx-auto max-w-3xl text-gray-600 text-xl">
              Chúng tôi luôn sẵn sàng lắng nghe và hỗ trợ bạn trong việc tạo ra không gian sống hoàn hảo
            </p>
          </div>
            ...
            <div data-aos="fade-right" data-aos-duration="1000">
              <div className="space-y-10">
                <div className="group flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="mb-3 font-bold text-gray-900 text-2xl">Địa Chỉ Showroom</h3>
                    <p className="text-gray-600 text-lg">123 Đường ABC, Quận 1, TP.HCM</p>
                    <p className="text-gray-600 text-lg">456 Đường XYZ, Quận Ba Đình, Hà Nội</p>
                  </div>
                </div>
                ...
                <div className="group flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="mb-3 font-bold text-gray-900 text-2xl">Số Điện Thoại</h3>
                    <p className="text-gray-600 text-lg">Hotline: 0123 456 789</p>
                    <p className="text-gray-600 text-lg">Tư vấn: 0987 654 321</p>
                  </div>
                </div>
                ...
                <div className="group flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="mb-3 font-bold text-gray-900 text-2xl">Email</h3>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white shadow-2xl p-10 border border-gray-100 rounded-3xl">
                <form className="space-y-8">
                  <div className="gap-6 grid grid-cols-1 md:grid-cols-2">
                    <div>
                      <label className="block mb-3 font-bold text-gray-700 text-sm">Họ và Tên</label>
                      <input 
                        type="text" 
                    ...
                    <div>
                      <label className="block mb-3 font-bold text-gray-700 text-sm">Số Điện Thoại</label>
                      <input 
                        type="tel" 
                        className="px-6 py-4 border-2 border-gray-200 focus:border-transparent rounded-xl focus:ring-2 focus:ring-amber-500 w-full text-lg transition-all duration-300"
                  ...
                  <div>
                    <label className="block mb-3 font-bold text-gray-700 text-sm">Email</label>
                    <input 
                      type="email" 
                      className="px-6 py-4 border-2 border-gray-200 focus:border-transparent rounded-xl focus:ring-2 focus:ring-amber-500 w-full text-lg transition-all duration-300"
                  ...
                  <div>
                    <label className="block mb-3 font-bold text-gray-700 text-sm">Nội Dung</label>
                    <textarea 
                      rows={5}
      ...
      <footer className="bg-gradient-to-b from-gray-900 to-black py-16 text-white">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="gap-12 grid grid-cols-1 md:grid-cols-4 mb-12">
            <div data-aos="fade-up" data-aos-delay="0">
              ...
              <p className="mb-6 text-gray-300 leading-relaxed">
                Nội thất cao cấp cho ngôi nhà hoàn hảo của bạn. Chúng tôi cam kết mang đến chất lượng tốt nhất.
              </p>
              <div className="flex gap-4">
                <a href="#" className="bg-gray-800 hover:bg-amber-600 p-3 rounded-full hover:scale-110 transition-all duration-300 transform">
                  <Facebook size={20} />
                </a>
                <a href="#" className="bg-gray-800 hover:bg-amber-600 p-3 rounded-full hover:scale-110 transition-all duration-300 transform">
                  <Instagram size={20} />
            ...
            <div data-aos="fade-up" data-aos-delay="100">
              <h3 className="mb-6 font-bold text-amber-400 text-xl">Sản Phẩm</h3>
              <ul className="space-y-3 text-gray-300">
                <li><a href="#" className="hover:text-amber-400 text-lg transition-colors duration-300">Sofa Cao Cấp</a></li>
                <li><a href="#" className="hover:text-amber-400 text-lg transition-colors duration-300">Bàn Ăn Luxury</a></li>
                <li><a href="#" className="hover:text-amber-400 text-lg transition-colors duration-300">Giường Ngủ Premium</a></li>
                <li><a href="#" className="hover:text-amber-400 text-lg transition-colors duration-300">Tủ Quần Áo</a></li>
              </ul>
            </div>
            ...
            <div data-aos="fade-up" data-aos-delay="200">
              ...
              <ul className="space-y-3 text-gray-300">
                <li><a href="#" className="hover:text-amber-400 text-lg transition-colors duration-300">Tư Vấn Thiết Kế</a></li>
                <li><a href="#" className="hover:text-amber-400 text-lg transition-colors duration-300">Giao Hàng Lắp Đặt</a></li>
                <li><a href="#" className="hover:text-amber-400 text-lg transition-colors duration-300">Bảo Hành 5 Năm</a></li>
                <li><a href="#" className="hover:text-amber-400 text-lg transition-colors duration-300">Hỗ Trợ 24/7</a></li>
              </ul>
            </div>
          ...
          <div className="pt-8 border-gray-700 border-t text-gray-300 text-center" data-aos="fade-up" data-aos-delay="400">
            <p className="text-lg">&copy; 2025 LuxuryHome. Tất cả quyền được bảo lưu. Thiết kế bởi đội ngũ chuyên nghiệp.</p>
          </div>
        </div>
      </footer>
    </div>
